...
this.err_select="Du har ikke udfyldt alle de obligatoriske felter.";
//this.err_enter="Please enter a valid \"%FIELDNAME%\"";
this.err_enter="Du har ikke udfyldt alle de obligatoriske felter.";
};
...
&&!(regex=="JSVAL_RX_CREDITCARD")&&!(regex=="JSVAL_RX_POSTALZIP")&&!(regex=="JSVAL_RX_DATE"))
{
nBegin=0;nEnd=0;
...
case "JSVAL_RX_EMAIL":
return((/^[a-zA-Z0-9üöäßÄÖÜ_]+([\.-]?[a-zA-ZüöäßÄÖÜ_]+)*@[a-zA-ZüöäßÄÖÜ]+([\.-]?[a-zA-ZüöäßÄÖÜ]+)*(\.\w{2,5})+$/).test(value));
